...
def createStat(username,userdata,isadmin):
    ...
    msg+= '🔌Proxy : ' + proxy + '\n\n'
    msg+= '⌨️Comandos⌨️\n'
    msg+= '/acc user,passw - Configura la Cuenta De La Nube\n'
    msg+= '/zips size - Configura los el tamaño de zips de compresion\n'
    msg+= '/host host - Configura El Host De lA Nube\n'
    msg+= '/moodle - Configura El Typo de Nube A Moodle\n'
    msg+= '/cloud - Configura El Typo de Nube A Nexcloud\n'
    msg+= '/proxy - Configura El proxy del bot\n'
    msg+= '/del_proxy - Elimina el proxy activo\n'
    msg+= '/uptype type - Configura El Typo de subida variando entre: draft, blog, evidencia\n'
    if userdata['cloudtype'] == 'moodle':
       msg+= '/repo id - Configura El RepoID De lA Nube\n'
    return msg